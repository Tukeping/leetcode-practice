...
public class LeetCode160 {
    ...
    @Test
    public void test1() {
        ListNode common = ListNodeHelper.build0(8, 4, 5);
        ListNode headA = ListNodeHelper.build0(4, 1);
        headA.next = common;
        ListNode headB = ListNodeHelper.build0(5, 0, 1);
        headB.next = common;
    ...
    @Test
    public void test2() {
        ListNode common = ListNodeHelper.build0(2, 4);
        ListNode headA = ListNodeHelper.build0(0, 9, 1);
        headA.next = common;
        ListNode headB = ListNodeHelper.build0(3);
        headB.next = common;
        ListNode ret = getIntersectionNode(headA, headB);
    ...
    @Test
    public void test3() {
        ListNode headA = ListNodeHelper.build0(2, 6, 4);
        ListNode headB = ListNodeHelper.build0(1, 5);
        ListNode ret = getIntersectionNode(headA, headB);
        assertNull(ret);
    }
}
