...
public class LeetCode82 {
    ...
    @Test
    public void test1() {
        ListNode head = ListNodeHelper.build0(1, 2, 3, 3, 4, 4, 5);
        ListNode res = deleteDuplicates(head);
        ListNodeHelper.check0(res, 1, 2, 5);
    }
    ...
    @Test
    public void test2() {
        ListNode head = ListNodeHelper.build0(1, 1, 1, 2, 3);
        ListNode res = deleteDuplicates(head);
        ListNodeHelper.check0(res, 2, 3);
    }
    ...
    @Test
    public void test3() {
        ListNode head = ListNodeHelper.build0(1, 1);
        ListNode res = deleteDuplicates(head);
        assertNull(res);
    }
}
