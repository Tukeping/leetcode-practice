package com.tukeping.leetcode.contest.weekly.contest174;
...
public class LeetCode1399 {
    ...
    public int maxProduct(TreeNode root) {
        ...
        int MOD = 1000000007;
        for (int sum : sumList) {
            ans = Math.max(ans, (long) sum * (totalSum - sum));
        }
        return (int) (ans % MOD);
    }
    ...
    @Test
    public void test1() {
        int n = maxProduct(TreeNodeHelper.build(1, 2, 3, 4, 5, 6));
        assertThat(n, is(110));
    }
    ...
    @Test
    public void test2() {
        int n = maxProduct(TreeNodeHelper.build(1, null, 2, 3, 4, null, null, 5, 6));
        assertThat(n, is(90));
    }
    ...
    @Test
    public void test3() {
        int n = maxProduct(TreeNodeHelper.build(2, 3, 9, 10, 7, 8, 6, 5, 4, 11, 1));
        assertThat(n, is(1025));
    }
