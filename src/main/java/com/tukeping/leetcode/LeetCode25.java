...
public class LeetCode25 {
    ...
    @Test
    public void test1() {
        ListNode res1 = reverseKGroup(ListNodeHelper.build0(1, 2, 3, 4, 5), 2);
        ListNodeHelper.check0(res1, 2, 1, 4, 3, 5);

        ListNode res2 = reverseKGroup(ListNodeHelper.build0(1, 2, 3, 4, 5), 3);
        ListNodeHelper.check0(res2, 3, 2, 1, 4, 5);
    }
}
