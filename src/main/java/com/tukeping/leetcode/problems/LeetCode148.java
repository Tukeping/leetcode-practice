...
public class LeetCode148 {
    ...
    @Test
    public void test1() {
        ListNode node = ListNodeHelper.as(4, 2, 1, 3);
        ListNode res = sortList(node);
        ListNodeHelper.assertThat(res, 1, 2, 3, 4);
    }
    ...
    @Test
    public void test2() {
        ListNode node = ListNodeHelper.as(-1, 5, 3, 4, 0);
        ListNode res = sortList(node);
        ListNodeHelper.assertThat(res, -1, 0, 3, 4, 5);
    }
}
