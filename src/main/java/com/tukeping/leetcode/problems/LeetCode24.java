...
public class LeetCode24 {
    ...
    @Test
    public void test1() {
        ListNode res = swapPairs(ListNodeHelper.as(1, 2, 3, 4));
        ListNodeHelper.assertThat(res, 2, 1, 4, 3);
    }

    @Test
    public void test2() {
        ListNode res = swapPairs(ListNodeHelper.as(1));
        ListNodeHelper.assertThat(res, 1);
    }

    @Test
    public void test3() {
        ListNode res = swapPairs(ListNodeHelper.as(1, 2, 3));
        ListNodeHelper.assertThat(res, 2, 1, 3);
    }
}
