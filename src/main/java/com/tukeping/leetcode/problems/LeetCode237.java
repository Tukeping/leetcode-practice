...
public class LeetCode237 {
    ...
    @Test
    public void test1() {
        ListNode head = ListNodeHelper.as(4, 5, 1, 9);
        ListNode node = ListNodeHelper.find(head, 5);
        assert node != null;
        deleteNode(node);
        ListNodeHelper.assertThat(head, 4, 1, 9);
    }
    ...
    public void test2() {
        ListNode head = ListNodeHelper.as(4, 5, 1, 9);
        ListNode node = ListNodeHelper.find(head, 1);
        assert node != null;
        deleteNode(node);
        ListNodeHelper.assertThat(head, 4, 5, 9);
    }
}
